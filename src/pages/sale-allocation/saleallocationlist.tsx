...
} from './saleAllocationData';

interface SaleAllocationListProps {
  onNew: () => void;
...
const SaleAllocationList: React.FC<SaleAllocationListProps> = ({
  onNew,
  onEdit,
  onNavigateToSaleAllocationList,
}) => {
  const [documents, setDocuments] = useState<SaleAllocationDocument[]>(
    extendedSaleAllocationDocuments
  );
  ...
  const insightItems = useMemo(() => {
    ...
    return [
      buildCountInsight({
        ...
        count: total,
        total,
        support: `${formatInsightCount(total)} allocation documents`,
        hint: `${formatInsightAmount(totalValue)} allocated value`,
        tone: 'neutral',
      }),
      buildCountInsight({
        key: 'pending',
        ...
        count: pending,
        total,
        support: `${pending} allocations need review`,
      ...
      buildCountInsight({
        ...
        count: approved,
        total,
        support: `${approved} allocations approved`,
        hint: `${getInsightPercent(approved, total)}% approved`,
        tone: 'success',
      }),
      buildCountInsight({
        key: 'high-value',
        label: 'High value allocations',
        count: highValue,
        total,
  ...
  const renderActionMenu = (item: SaleAllocationDocument) => (
    <div
  ...
  return (
    ...
    >
          ...
          <div className="catalogue-toolbar__top">
            <div className="catalogue-toolbar__heading">
              <div className="catalogue-toolbar__title-row">
                <button type="button" className="catalogue-toolbar__title-button" aria-label="Sale allocation catalogue">
                  <h2 className="brand-page-title">My Sale Allocation</h2>
                </button>
              ...
              <div className="catalogue-toolbar__utility-group">
                <div className="catalogue-toolbar__search">
                  ...
                  <input
                    ...
                    aria-label="Search sale allocations"
                  />
                </div>

                <div className="catalogue-view-toggle" role="group" aria-label="Sale allocation view mode">
                  <button
                    type="button"
                ...
                <button
                  ...
                  aria-label={hasActiveFilters ? `Filter sale allocations. ${activeFilterCount} filters applied.` : 'Filter sale allocations'}
                >
                  <Filter size={16} />
                  Filters
      ...
      <div className="mx-auto flex w-full max-w-[1800px] flex-col gap-4 px-4 py-4">
        {loadState === 'ready' && (
          <CatalogueInsightCards
            ...
            ariaLabel="Sale allocation insights"
        ...
        {loadState === 'ready' && sortedRows.length === 0 && (
          <div className="flex flex-col items-center rounded border border-dashed border-slate-300 bg-slate-50 px-6 py-12 text-center">
            ...
            <h2 className="text-lg font-bold text-slate-900">No sale allocations found</h2>
        ...
        {loadState === 'ready' && sortedRows.length > 0 && catalogueViewMode === 'list' && (
          <div className="catalogue-table-scroll">
            <table className="catalogue-table">
              <thead>
                <tr>
                  <SortableTableHeader label="SA No." sortKey="number" sortState={sortState} onSortChange={handleSortChange} />
      ...
      <CatalogueFilterDrawer
        ...
        subtitle="Narrow down sale allocations by customer, priority, warehouse, and delivery window."
      ...
      <DocumentPreviewDrawer
        ...
        documentTypeLabel="Sale Allocation"
        subtitle="Sale Allocation preview"
        printEntityType="sale-allocation"
...
export default SaleAllocationList;

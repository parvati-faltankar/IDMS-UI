...
import { extendedSaleOrderV2Documents, type SaleOrderV2Document as SaleOrderDocument } from './saleOrderV2Data';
...
const SaleOrderV2List: React.FC<SaleOrderListProps> = ({
  onNew,
  onEdit,
  onNavigateToSaleOrderList,
}) => {
  const [documents, setDocuments] = useState<SaleOrderDocument[]>(extendedSaleOrderV2Documents);
      ...
      <div className="mx-auto flex w-full max-w-[1800px] flex-col gap-4 px-4 py-4">
        ...
        {loadState === 'ready' && sortedRows.length > 0 && catalogueViewMode === 'list' && (
          <CommonDataGrid
            ...
            ariaLabel="Sale orders V2 table"
            rows={sortedRows}
            columns={gridColumns}
            rowId={(item) => item.id}
            sortState={sortState}
...
export default SaleOrderV2List;

...
import type {
  ...
  AdminSetupItem,
  AdminSetupStatus,
} from './AdminSetupAssistant.types';
...
const STATUS_BADGE_STYLE: Record<AdminSetupStatus, React.CSSProperties> = {
  complete: {
  ...
  'in-progress': {
    ...
    color: 'color-mix(in srgb, #3b82f6 85%, var(--color-text))',
  },
  'not-started': {

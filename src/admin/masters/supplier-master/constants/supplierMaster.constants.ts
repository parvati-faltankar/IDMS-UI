...
export const MOCK_ITEMS: { code: string; name: string; category: string; uom: string }[] = [
  { code: 'ITM-001', name: 'Engine Oil Filter',       category: 'Filters',      uom: 'Each' },
  { code: 'ITM-002', name: 'Brake Pad Assembly',      category: 'Brakes',       uom: 'Set' },
  { code: 'ITM-003', name: 'Air Filter Element',      category: 'Filters',      uom: 'Each' },
  { code: 'ITM-004', name: 'Spark Plug Set',          category: 'Ignition',     uom: 'Set' },
  { code: 'ITM-005', name: 'Clutch Plate Kit',        category: 'Transmission', uom: 'Set' },
  { code: 'ITM-006', name: 'Fuel Injector',           category: 'Fuel System',  uom: 'Each' },
  { code: 'ITM-007', name: 'Radiator Assembly',       category: 'Cooling',      uom: 'Each' },
  { code: 'ITM-008', name: 'Alternator Unit',         category: 'Electrical',   uom: 'Each' },
  { code: 'ITM-009', name: 'Timing Belt Kit',         category: 'Engine',       uom: 'Each' },
  { code: 'ITM-010', name: 'Shock Absorber Front',    category: 'Suspension',   uom: 'Each' },
  { code: 'ITM-011', name: 'Brake Disc Rotor',        category: 'Brakes',       uom: 'Each' },
  { code: 'ITM-012', name: 'Fuel Filter Cartridge',   category: 'Filters',      uom: 'Each' },
  { code: 'ITM-013', name: 'Starter Motor',           category: 'Electrical',   uom: 'Each' },
  { code: 'ITM-014', name: 'Water Pump Assembly',     category: 'Cooling',      uom: 'Each' },
  { code: 'ITM-015', name: 'Gearbox Seal Kit',        category: 'Transmission', uom: 'Set' },
  { code: 'ITM-016', name: 'Coil Spring Set',         category: 'Suspension',   uom: 'Set' },
  { code: 'ITM-017', name: 'Piston Ring Set',         category: 'Engine',       uom: 'Set' },
  { code: 'ITM-018', name: 'Battery 12V 65Ah',        category: 'Electrical',   uom: 'Each' },
  { code: 'ITM-019', name: 'Bonnet Latch Assembly',   category: 'Body Parts',   uom: 'Each' },
  { code: 'ITM-020', name: 'Cabin Air Filter',        category: 'Filters',      uom: 'Each' },
];

...
export const WH_KHIVRAJ_SAMPLE: Warehouse = {
  id: 'WH-0006',
  warehouseCode: 'WH-KHIV',
  warehouseName: 'Khivraj Warehouse',
  description: 'Sample warehouse for create-time level builder and configuration walkthrough.',
  ownershipScope: 'Organization',
  owningOrgCode: 'ORG-001',
  warehouseType: 'Physical',
  wmsEnabled: true,
  ...
  assignmentProfile: {
    assignments: [],
    sharedWithAllBranches: true,
    inventoryOwner: { ownerCode: 'OWN-001', ownerName: 'Khivraj Auto', ownerType: 'Company' },
  },
  defaultLocations: {
    putaway: { purpose: 'Putaway', locationId: 'LOC-KHIV-0003', locationCode: 'BIN-001', locationName: 'BIN 001' },
    picking: { purpose: 'Picking', locationId: 'LOC-KHIV-0003', locationCode: 'BIN-001', locationName: 'BIN 001' },
  },
  autoPutaway: { enabled: true, strategy: 'FEFO', strategySequence: ['FEFO', 'Nearest-Empty'], overrideAllowed: true },
  autoPicking: { enabled: true, strategy: 'FEFO', strategySequence: ['FEFO', 'FIFO'], overrideAllowed: true },
  capacityPolicy: {
    trackingEnabled: true,
    squareFootage: 18000,
  ...
  eligibilityPolicy: { mode: 'Restricted', rules: [], defaultFallback: 'Allow' },
  reservationPolicy: {
    reservationLevel: 'BIN',
    eligibleLocationTypes: ['BIN'],
    allowPartialReservation: true,
...
export const SEED_HIERARCHY_TEMPLATES: HierarchyTemplate[] = [
  ...
  },
  {
    id: 'HTPL-0003',
    warehouseId: 'WH-0006',
    templateCode: 'KHIV-TPL',
    templateName: 'Khivraj Warehouse Template',
    status: 'Active',
    flexiblePathEnabled: true,
    levels: [
      { levelId: 'LVL-KHIV-ZONE', levelCode: 'ZONE', levelName: 'Zone', sequence: 1, mandatory: true, leafEligible: false, allowSkipLevel: false, allowedParentLevels: ['WAREHOUSE'], allowedChildLevels: ['RACK'], capacityApplicable: false, itemEligibilityApplicable: false, responsibilityApplicable: true, inventoryEndpointEligible: false, barcodeApplicable: false, qrApplicable: false, transactionPurposes: ['Storage'], capacityEnforcementMode: 'None', capacityRollupMode: 'None', allowCapabilityOverride: true, defaultLocationRole: 'Structural', defaultLocationType: 'Zone' },
      { levelId: 'LVL-KHIV-RACK', levelCode: 'RACK', levelName: 'Rack', sequence: 2, mandatory: true, leafEligible: false, allowSkipLevel: false, allowedParentLevels: ['ZONE'], allowedChildLevels: ['BIN'], capacityApplicable: true, itemEligibilityApplicable: false, responsibilityApplicable: true, inventoryEndpointEligible: false, barcodeApplicable: true, qrApplicable: false, transactionPurposes: ['Storage', 'Replenishment'], capacityEnforcementMode: 'Warning', capacityRollupMode: 'RollupFromChildren', allowCapabilityOverride: true, defaultLocationRole: 'Structural', defaultLocationType: 'Rack' },
      { levelId: 'LVL-KHIV-BIN', levelCode: 'BIN', levelName: 'BIN', sequence: 3, mandatory: true, leafEligible: true, allowSkipLevel: false, allowedParentLevels: ['RACK'], allowedChildLevels: [], capacityApplicable: true, itemEligibilityApplicable: true, responsibilityApplicable: true, inventoryEndpointEligible: true, barcodeApplicable: true, qrApplicable: true, transactionPurposes: ['Storage', 'Putaway', 'Picking'], capacityEnforcementMode: 'HardBlock', capacityRollupMode: 'OwnCapacityOnly', allowCapabilityOverride: true, defaultLocationRole: 'InventoryEndpoint', defaultLocationType: 'BIN' },
    ],
    currentVersion: { versionNumber: 1, activatedAt: '2026-06-05T00:00:00.000Z' },
    versionHistory: [{ versionNumber: 1, activatedAt: '2026-06-05T00:00:00.000Z' }],
...
export const SEED_LOCATIONS: WarehouseLocation[] = [
  ...
  },
  {
    id: 'LOC-KHIV-0002',
    warehouseId: 'WH-0006',
    parentLocationId: 'LOC-KHIV-0001',
    ...
    profile: {
      locationType: 'Rack',
      level: 2,
      fullCode: 'WH-KHIV-ZONE-A-RACK-A1',
      isLeafEndpoint: false,
      inventoryAllowed: false,
    },
    putawayBlocked: false,
  ...
  },
  {
    id: 'LOC-KHIV-0003',
    warehouseId: 'WH-0006',
    parentLocationId: 'LOC-KHIV-0002',
    ...
    profile: {
      locationType: 'BIN',
      level: 3,
      fullCode: 'WH-KHIV-ZONE-A-RACK-A1-BIN-001',
      isLeafEndpoint: true,
      inventoryAllowed: true,
    },
    capacity: { maxWeightKg: 300, maxVolumeM3: 1.5, maxUnits: 120 },
    putawayBlocked: false,
    pickingBlocked: false,
    movementState: 'Idle',
    commitmentState: 'Uncommitted',
